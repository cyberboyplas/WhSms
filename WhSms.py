...
\033[93m By WhBeatZ  \033[92mGithub: https://github.com/WhBeatZ   \033[91mv1.0
\033[96m                                         """
    print(logo)
    print("\n")
...
if type == 1:
	...
	while True:
		...
		cc = input("\033[96m\tPon el codigo de pais (Sin el \033[93m +\033[96m, elejmplo: 34, 52) :\033[93m ")
		if '+' in cc:
		        tc = list(cc)
		        tc.remove('+')
		        cc = ''.join(tc)
		...
		if len(cc) >= 4 or len(cc) < 1:
		        ...
		        continue
		pn = input("\033[96mPon el numero de telefono xd : \033[93m+" + cc + " ")
		if len(pn) <= 6:
		...
		if not numbe.isdigit():
		            ...
		            continue
		receiver = '+' + numbe
		text = input("\033[96mEscribe el mensaje a enviar :) :\033[93m ")
	
		#respuesta de textbell
		...
		print(resp.json())
		print("\033[95mGracias por usar WhSms, mi inta: WhBeatZ :)...")
		break
